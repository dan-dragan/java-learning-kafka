 ...
 * */
public class SafeTwitterProducer {
    class TwitterClient {
        String bearerToken = "";
    ...
    public void run(){
        Logger logger = LoggerFactory.getLogger(SafeTwitterProducer.class.getName());
    ...
    public static void main(String args[]) throws IOException, URISyntaxException {
        SafeTwitterProducer producer = new SafeTwitterProducer();
        producer.run();
    }
